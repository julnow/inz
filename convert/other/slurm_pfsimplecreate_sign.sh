...
#done
#for ((i=2000+5*(INDEX-1); i<=2000+5*INDEX; i++)); do
#  echo /lustre/cbm/users/lubynets/cbm2atree/outputs/apr20_fr_18.2.1_fs_jun19p1/dcmqgsm_smm_pluto/auau/3.3agev/mbias/sis100_electron_target_25_mkm_psd_v18e_p3.3_56/AT2/$i/$i.analysistree.root >>  $list
#done
# 27.5% magnetic field
