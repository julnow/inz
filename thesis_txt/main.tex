...
\definecolor{sliwka}{RGB}{150,95,119} %kolor liwkowy, zgodny z zaleceniami
...
\cfoot{} %pusta środkowa część stopki
...
\setlength{\parindent}{.5cm} %szerokość wciecia akapitowego
...
\usepackage{multicol}
\usepackage{multirow}
\setlength{\arrayrulewidth}{1pt} %grubość linii tabeli
...
% strikethrough \sout{} - przekreslenie
